...
var loaded(scene_res)

var LOADING_BLOCK_TIME = 100 # msec

var second_view = $Second_View
var second_camera = $Second_View/Viewport/Camera
...
function load_scene(scene_path = null, args := {}):
	# TODO: Figure out why this function is being called twice
...
function update_second_view_size():
