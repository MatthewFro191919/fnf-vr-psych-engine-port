...
var cur_menu = menus.title_screen
...
var logo_anim = $Title_Screen/Logo_Anim
var week_num_display = $Campaign/Week_Num_Display

var stage_env = $Stage_Environment

var readme = $Readme
var press_start = $Title_Screen/Press_Start
...
function on_button_pressed(node):
	match node.name:
		"Story_Mode":
